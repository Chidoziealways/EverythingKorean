...
val modVersion = libs.get().findVersion("everythingkorean").get()
...
val everythingJapaneseVersionRange = "[1.15.0,)"
...
tasks.withType<ProcessResources>().configureEach {
    ...
    val expandProps = mapOf(
        ...
        "everything_japanese_version_range" to everythingJapaneseVersionRange,
